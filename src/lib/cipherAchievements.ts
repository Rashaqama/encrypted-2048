export const CIPHER_ACHIEVEMENTS_CHAIN_ID = 421614; // Arbitrum Sepolia
export const CIPHER_ACHIEVEMENTS_ADDRESS =
  "0x0985C11Fe9B9252a1946Ec5734585ABB167F1F00";
...
export const CIPHER_ACHIEVEMENTS_ABI = [
  ...
  },
  {
    inputs: [
      ...
      { internalType: "enum CipherAchievements.Level", name: "", type: "uint8" },
    ],
    name: "hasClaimed",
    outputs: [{ internalType: "bool", name: "", type: "bool" }],
    stateMutability: "view",
  ...
  },
  {
    inputs: [{ internalType: "uint256", name: "tokenId", type: "uint256" }],
    name: "levelOf",
    outputs: [{ internalType: "enum CipherAchievements.Level", name: "", type: "uint8" }],
    stateMutability: "view",
    type: "function",
  },
  {
